...
import RevertBlackListModal from "./RevertBlackListModal";
import { Pagination } from "../../../../../components";

function UserBlackListCard({ data, page, setPage, totalPage }) {
  const drawCardList = () => {
            ...
            <Styles.CardContainer>
              <Styles.CardContent>
                <Grid container spacing={1} justify="flex-end">
                  <Styles.CardHeader>
                    <RevertBlackListModal userData={item} />
                  </Styles.CardHeader>
                </Grid>
...
export default UserBlackListCard;
