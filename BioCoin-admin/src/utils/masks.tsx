...
function formatSmallNumberValues(
  value?: any,
  isMoney?: any,
  floatNumber?: any,
  negative?: any
...
//------------------------------------Mascara coordenadas-------------------------------
// 48°33'10.00" W
// function LatitudeMask(value?: any) {
//   const regexData = /^(\d{2})°(\d{2})′(\d{2}\.\d{2})″[SN]$/;
//   if (!value) {
//     return value;
//   }
//   if (value.length > 9) {
...
// 48°33'10.00" W
// function LongitudeMask(value?: any) {
//   const regexData = /^(\d{2})°(\d{2})′(\d{2}\.\d{2})″[SN]$/;
//   if (!value) {
//     return value;
//   }
...
// }
//-----------------------------------------------------------------------------------------
//---------------------------------Conversão e Formatação coordenadas-----------------------
// function toDMS(deg) {
//   var d = Math.floor(deg);
//   var min = Math.floor((deg - d) * 60);
//   var sec = ((deg - d - min / 60) * 3600).toFixed(1);
//   return d + "°" + min + "'" + sec + '"';
// }

// function formatLatitude(inputValue) {
//   var latitudeDMS = inputValue >= 0 ? "N" : "S";
//   inputValue = Math.abs(inputValue);
//   var latDMSString = toDMS(inputValue);

//   return latDMSString + " " + latitudeDMS;
// }

// function formatLongitude(inputValue) {
//   var longitudeDMS = inputValue >= 0 ? "E" : "W";
//   inputValue = Math.abs(inputValue);
//   var longDMSString = toDMS(inputValue);

//   return longDMSString + " " + longitudeDMS;
// }

// function ParseLatitudeDMS(inputValue) {
//   var parts = inputValue.split(/[^\d\w\.]+/);
//   var latitude = ConvertDMSToDD(parts[0], parts[1], parts[2], parts[3]);
//   return latitude;
// }

// function ParseLongitudeDMS(inputValue) {
//   var parts = inputValue.split(/[^\d\w\.]+/);
//   var longitude = ConvertDMSToDD(parts[0], parts[1], parts[2], parts[3]);
//   return longitude;
// }
