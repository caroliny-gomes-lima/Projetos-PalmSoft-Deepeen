...
export default function getCapacityCheckoutProcessCharts(response) {
  return {
    ...response,
    data: createChartData(
      response,
      [
        colors.checkout.ideal,
        colors.checkout.actual,
        colors.checkout.idealBorder,
      ],
      [colors.checkout.doughnutPrimary, colors.checkout.doughnutSecundary]
    ),
  };
}
